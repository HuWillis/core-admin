package com.example.core.admin.common.constants;

/**
 * @author hy
 * @title: RedisKeyConstants
 * @projectName core-admin
 * @description: System Redis Key 枚举类
 * @date 2024-10-21 10:14:30 10:14
 */
public interface RedisKeyConstants {
     ...
     * 拥有指定菜单的角色编号的缓存
     * <p>
     * KEY 格式：menu_role_ids:{menuId} VALUE 数据类型：String 角色编号集合
     */
     ...
     * 访问令牌的缓存
     * <p>
     * KEY 格式：oauth2_access_token:{token} VALUE 数据类型：String 访问令牌信息
     * <p>
